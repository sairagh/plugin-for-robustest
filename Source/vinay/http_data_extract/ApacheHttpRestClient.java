...
/**
 * Created by krishnav1 on 28-09-2016.
 */
public class ApacheHttpRestClient {
    ...
    public final static void main(String[] args) {
        ...
        try {
            ...
            HttpGet httpGetRequest = new HttpGet("http://mobile.robustest.com/api/1/device");
          ...
          //  System.out.println("----------------------------------------");
           // System.out.println(httpResponse.getStatusLine());
            Messages.showMessageDialog(String.valueOf(httpResponse.getStatusLine()), "MESSAGE", Messages.getInformationIcon());
           // System.out.println("----------------------------------------");
                ...
                try {
                    ...
                    while ((bytesRead = bis.read(buffer)) != -1) {
                     ...
                     //   System.out.println(chunk);
                        Messages.showMessageDialog(chunk, "MESSAGE", Messages.getInformationIcon());
                    }
